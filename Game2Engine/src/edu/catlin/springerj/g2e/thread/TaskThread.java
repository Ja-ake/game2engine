...
public class TaskThread extends Thread {
	...
	public Task add(Task t, int type) {
		...
		// System.out.println(continuousBuffer.size());
	...
	private void swapBuffers() {
		noncontinuousTasks = new ArrayList<Task>(noncontinuousBuffer);
		noncontinuousBuffer.clear();
		continuousTasks = new ArrayList<Task>(continuousBuffer);
		// Logger.println(continuousTasks.size() + " " +
		// continuousBuffer.size());
	}
