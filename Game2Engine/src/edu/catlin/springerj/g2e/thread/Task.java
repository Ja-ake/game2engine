...
public abstract class Task implements Runnable {
	...
	public Task() { id = (int) Math.floor(Math.random() * ((double)Integer.MAX_VALUE)); priority = PRIORITY_NORMAL; }
	public Task(int p) { id = (int) Math.floor(Math.random() * ((double)Integer.MAX_VALUE)); priority = p; }
