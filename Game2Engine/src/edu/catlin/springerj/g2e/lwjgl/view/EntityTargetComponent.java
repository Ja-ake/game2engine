...
public class EntityTargetComponent extends AbstractComponent {
	...
	public EntityTargetComponent(AbstractEntity e) {
		try { position = e.getComponent(PositionComponent.class); }
		catch (InvalidComponentException ex) { throw new RuntimeException("Invalid target: does not contain PositionComponent"); }
		entity = e;
	}
